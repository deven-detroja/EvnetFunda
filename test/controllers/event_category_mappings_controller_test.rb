...
class EventCategoryMappingsControllerTest < ActionController::TestCase
  ...
  test "should create event_category_mapping" do
    assert_difference('EventCategoryMapping.count') do
      post :create, event_category_mapping: { categories_id: @event_category_mapping.categories_id, event_master_id: @event_category_mapping.event_master_id, sub_categories_id: @event_category_mapping.sub_categories_id }
    end
  ...
  test "should update event_category_mapping" do
    patch :update, id: @event_category_mapping, event_category_mapping: { categories_id: @event_category_mapping.categories_id, event_master_id: @event_category_mapping.event_master_id, sub_categories_id: @event_category_mapping.sub_categories_id }
    assert_redirected_to event_category_mapping_path(assigns(:event_category_mapping))
  end
